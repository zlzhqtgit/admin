		...
		<div class="layui-tab-content">
			<div class="layui-tab-item layui-show ">
				...
				<div class="layui-form-item layui-form-text ">
					...
					<div class="layui-input-block">
						<textarea id="personalityBrief" name="personalityBrief"  placeholder="请输入内容" class="layui-textarea"	style="min-height: 80px;"></textarea>
					</div>
				</div>
				<div class="layui-form-item layui-form-text ">
					<label class="layui-form-label">测评详细描述</label>
					<div class="layui-input-block">
						<textarea id="personalityDetial" name="personalityDetial"  placeholder="请输入内容" class="layui-textarea"style="min-height: 80px;"></textarea>
					</div>
				</div>				
				...
				<div style="position: fixed; top: 0px; right: 0;">
					<button type="button" class="layui-btn layui-btn-fluid"	onclick="addpet()">添加数据</button>
				</div>
			</div>
		</div>
	</form>
