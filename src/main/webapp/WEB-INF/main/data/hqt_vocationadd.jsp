	...
	<form id="form-vocation"class="layui-form layui-form-pane" action="">
		<div class="layui-tab">
			...
			<div style="width: 216px; margin: 0; display: inline-block; float: right; margin-top: -40px; position: absolute; right: 15px;">
				<button type="button" class="layui-btn layui-btn-fluid"	onclick="add()">添加数据</button>
			</div>
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show ">
					<div class="layui-form-item disbl">
						...
						<div class="layui-input-block">
							<input type="text" id="vocationId" name="vocationId" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item disbl">
						<label class="layui-form-label disbl">职业名称</label>
						<div class="layui-input-block">
							<input type="text" id="vocationName" name="vocationName"  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item disbl">
						<label class="layui-form-label">行业名称</label>
						<div class="layui-input-block">
							<input type="text" id="industryName" name="industryName"  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">							
						</div>
					</div>
					<div class="layui-form-item disbl">
						<label class="layui-form-label">行业大类</label>
						<div class="layui-input-block">
							<input type="text" id="industryMajorName" name="industryMajorName"  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">								
						</div>
					</div>
					...
					<fieldset class="layui-elem-field layui-field-title">
						...
						<div class="layui-form-item layui-form-text disbl"	style="width: 49%;">
							...
							<div class="layui-input-block">
								<textarea id="vocationBrief" name="vocationBrief"  placeholder="请输入内容" class="layui-textarea"style="min-height: 80px;"></textarea>
							</div>
						</div>
						<div class="layui-form-item layui-form-text disbl"	style="width: 49%;">
							<label class="layui-form-label">工作经验</label>
							<div class="layui-input-block">
								<textarea id="workExperience" name="workExperience" placeholder="请输入内容" class="layui-textarea"style="min-height: 80px;"></textarea>
							</div>
						</div>
						<br>
						<div class="layui-form-item layui-form-text disbl"	style="width: 49%;">
							...
							<div class="layui-input-block">
								<textarea id="workContent" name="workContent"  placeholder="请输入内容" class="layui-textarea"	style="min-height: 80px;"></textarea>
							</div>
						</div>
						<div class="layui-form-item layui-form-text disbl"style="width: 49%;">
							<label class="layui-form-label">教育要求</label>
							<div class="layui-input-block">
								<textarea id="educationCredential" name="educationCredential"  placeholder="请输入内容" class="layui-textarea"style="min-height: 80px;"></textarea>
							</div>
						</div>
					</fieldset>
				</div>
				<div class="layui-tab-item">
					<div class="layui-form-item disbl">
						...
						<div class="layui-input-block">
							<input type="text" id="requirementQualification" name="requirementQualification" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item disbl">
						<label class="layui-form-label disbl">学历要求</label>
						<div class="layui-input-block">
							<input type="text" id="educationQualification" name="educationQualification" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item disbl">
						<label class="layui-form-label disbl">专业知识</label>
						<div class="layui-input-block">
							<input type="text" id="specialtyKnow" name="specialtyKnow"  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item disbl">
						<label class="layui-form-label disbl">专业技能</label>
						<div class="layui-input-block">
							<input type="text" id="specialtySkill" name="specialtySkill" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
						</div>
					</div><br>
					<div class="layui-form-item disbl">
						<label class="layui-form-label disbl">工作年限</label>
						<div class="layui-input-block">
							<input type="text" id="workYear" name="workYear"  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item disbl">
						<label class="layui-form-label disbl">工作成果</label>
						<div class="layui-input-block">
							<input type="text" id="workAchieved" name="workAchieved"  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item disbl">
						<label class="layui-form-label disbl">组织能力</label>
						<div class="layui-input-block">
							<input type="text" id="organizationAbility" name="organizationAbility"  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item disbl">
						<label class="layui-form-label disbl">统筹能力</label>
						<div class="layui-input-block">
							<input type="text" id="planAbility" name="planAbility"  lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
						</div>
					</div>
					<fieldset class="layui-elem-field layui-field-title">
